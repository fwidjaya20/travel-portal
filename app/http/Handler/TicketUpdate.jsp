...
<%
	...
	if (validator.isEmpty(id)) {
        errorMsg = "Cant update ticket! ID is missing";
        hasError = true;
    } else if (validator.isEmpty(airline)) {
        ...
        errorMsg = "Ticket depature must be filled!";
        hasError = true;
	...
	if ( controller.updateTicket(id, airline, from_id, to_id, price_economy, price_business, available, depature_date) ) {
